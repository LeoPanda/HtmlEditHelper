 ...
 * <a href="xxx.JPG" imageanchor="1" style="margin-left: 1em; margin-right: 1em;">
 * <img border="0" src="xxxx.JPG" height="266" width="400" /></a>
 * </div>
 * <div style="text-align: center;">
 * <button id="slideShowButton"></button>
 * </div>
 * <script src="xxxx/slideShow.js" type="text/javascript"></script>
 * <script>
...
function slideShow() {  
  ...
  function initializeSlideShowMarkupData() {  
    ...
    for (var i = 0; i < slideCount; i++) { 
      ...
      globals.slideImages[i].parentElement.style.position = "absolute";
