 ...
 *
 */
public class SyntaxHilighterHelper extends PanelBase {
	//固定文字列
	private final String HOST_URL = GWT.getHostPageBaseURL();
	//バリデータ
	private RequiredValidator isRequired = new RequiredValidator();
	//フィールド
	private ListBoxField brush
			= new ListBoxField("brush","ソースの種類:",null,setBrushList());
	private ListBoxField css
			= new ListBoxField("css","修飾のスタイル:",null,setCSSList());
