...
public enum SyntaxCss implements ListElement{
  DEFAULT("標準", "Default.css"),
  DJANGO("Django", "Django.css"),
  ECLIPSE("Eclipse", "Eclipse.css"),
  EMACS("Emacs", "Emacs.css"),
  FADETOGRAY("FadeToGray", "FadeToGray.css"),
  MDULTR("MDUltra", "MDUltra.css"),
